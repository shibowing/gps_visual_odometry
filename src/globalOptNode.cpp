...
void vio_callback(const nav_msgs::Odometry::ConstPtr &pose_msg)
{
    ...
    // step1: recevie the visual-inertial odometry
    ...
    // step4:extracted fused globalpose and publish
